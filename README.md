...
"# anderslundback"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/anderslundback/anderslundback.git git push -u origin master
#   a n d e r s l u n d b a c k  
 